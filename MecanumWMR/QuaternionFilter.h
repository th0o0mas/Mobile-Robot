/* 
 * The code in this file "QuaternionFilter.h" is referenced and modified 
...
public:
    ...
    void updateIMU(float gx, float gy, float gz, float ax, float ay, float az, float* q)
    {
        double q0 = q[0], q1 = q[1], q2 = q[2], q3 = q[3];  // short name local variable for readability
        float recipNorm;
        float s0, s1, s2, s3;
